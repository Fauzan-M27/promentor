...
<head>
    ...
    <title>Admin Panel — PRO-MENTOR JTIK UNM</title>
    ...
    <style>
        ...
        /* PAGINATION */
        .adm-pagination { display:flex; justify-content:center; gap:4px; padding:16px; }
        .adm-pagination a, .adm-pagination span {
            font-size:12px; padding:6px 12px; border-radius:6px;
            border:1px solid #e2e8f0; color:#374151; text-decoration:none;
